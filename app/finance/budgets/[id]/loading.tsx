    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-2xl mx-auto mt-8">
        ...
        <div className="bg-card rounded-lg shadow p-6 mb-6">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <div className="h-4 w-40 bg-muted/50 rounded animate-pulse mt-1" />
            </div>
        ...
        <div className="bg-card rounded-lg shadow p-6 mt-6">
          <div className="h-7 w-48 bg-muted/50 rounded animate-pulse mb-6" />

          <div className="mb-6">
            <div className="flex justify-between items-center mb-2">
              <div>
                <div className="h-4 w-64 bg-muted/50 rounded animate-pulse mb-2" />
            ...
            <div className="w-full bg-muted/50 rounded-full h-4 overflow-hidden">
              <div className="h-full bg-muted animate-pulse" style={{ width: '40%' }} />
            </div>
          </div>
              ...
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="border border-border rounded-lg p-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="text-right">
                      <div className="h-4 w-28 bg-muted/50 rounded animate-pulse mb-1" />
                      <div className="h-3 w-12 bg-muted/50 rounded animate-pulse" />
                    </div>
                  </div>
                  <div className="w-full bg-muted/50 rounded-full h-2 overflow-hidden">
                    <div className="h-full bg-muted animate-pulse" style={{ width: '60%' }} />
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-card rounded-lg shadow p-6 mt-6">
          <div className="h-7 w-40 bg-muted/50 rounded animate-pulse mb-6" />

          <div className="space-y-6">
            {[1, 2].map((group) => (
              <div key={group}>
                <div className="h-4 w-20 bg-muted/50 rounded animate-pulse mb-3" />
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
